...
\begin{tikzpicture}
	\begin{semilogyaxis}[xlabel="Time (s)", ylabel=$Err_2$, legend pos=south east]
		\addplot[color=black, solid, mark=none] table[x index=0, y index=1, col sep=comma] {../results/validation/diffusion/errors.dat};
		\addlegendentry{u component}
		\addplot[color=black, ultra thick, dashed, mark=none] table[x index=0, y index=2, col sep=comma] {../results/validation/diffusion/errors.dat};
		\addlegendentry{v component}
		\addplot[color=black, loosely dashed, mark=none] table[x index=0, y index=3, col sep=comma] {../results/validation/diffusion/errors.dat};
