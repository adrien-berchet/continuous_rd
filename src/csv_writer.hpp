 ...
 * \file csv_writer.hpp
 *
 * \brief Provides a class to write CSV files.
 *
*/
...
namespace generic
{
    ...
    */
    ...
    public:
        ...
        /**
         * \brief Constructor of the CsvWriter.
         * \param file_name Name of the file.
         * \param mode Open mode. The default mode is std::ofstream::out | std::ofstream::binary | std::ofstream::trunc.
         * \param delimiter Delimiter used to create CSV columns. The default value is a comma.
        */
        CsvWriter(const std::string& file_name, const std::ios_base::openmode& mode = std::ofstream::out | std::ofstream::binary | std::ofstream::trunc, const std::string& delimiter = ",") : _file_name(file_name), _mode(mode), _delimiter(delimiter)
        {
            open();
        };
         ...
         * \param delimiter Delimiter used to create CSV columns. The default value is a comma.
        */
        CsvWriter(const std::string& file_name, const std::string& delimiter) : _file_name(file_name), _delimiter(delimiter)
        {
        ...
        */
        ...
        void write_row(ColNames... cols)
        {
            ...
            {
                throw std::runtime_error("Error in CsvWriter: The number of elements must be equal to number of columns : " + n + " != "+std::to_string(_n_cols));
            }
            else
            {
                write_row_sub(cols...);
